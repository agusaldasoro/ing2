...
FactoryGirl.create(:location, lat: -34.5455925, lng: -58.4402055,
                              address: 'Intendente Güiraldes 22', bar: bar1)
FactoryGirl.create(:location, lat: -34.546155, lng: -58.4407214,
                              address: 'Intendente Güiraldes 24', bar: bar2)
FactoryGirl.create(:location, lat: -34.556668, lng: -58.4498764,
                              address: 'Juramento 1499', bar: bar3)
FactoryGirl.create(:location, lat: -34.5452241, lng: -58.4410597,
                              address: 'Intendente Güiraldes 200', bar: bar4)
FactoryGirl.create(:location, lat: -34.5814989, lng: -58.4259446,
                              address: 'Güemes 4600', bar: bar5)
FactoryGirl.create(:location, lat: -34.5805564, lng: -58.4275314,
                              address: 'Güemes 4800', bar: bar6)
FactoryGirl.create(:location, lat: -34.5574032, lng: -58.451084,
